...
const DownloadForm = ({ handleClose,handleOpenSnackBar,pieceInfo}) => {
    console.log("piece",pieceInfo)
        ...
        <Paper >
            <CustomStack>
                ...
                >
                    ...
                    <Stack>
                        <InputLabel><b>Nombre Completo *</b></InputLabel>
                        <TextField
                            required
                            id="nombreCompleto"
                            name="fullName"
                        ...
                        <Stack>
                        <InputLabel><b>Correo Electrónico*</b></InputLabel>
                        <TextField
                            required
                            id="email"
                            name="email"
                        ...
                        <Stack>
                        <InputLabel><b>Institución *</b></InputLabel>
                        <Select
                            // required
                            id="institution"
                            name="institution"
                        ...
                        <Stack>
                        <InputLabel><b>Motivo de solicitud (Opcional)</b></InputLabel>
                        <TextField
                            id="description"
                            name="description"
                            label="Comentario"
